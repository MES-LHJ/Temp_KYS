...
namespace WindowsFormsApp1
{
    ...
    {
        DeptInfoForm _frm1;
        public DeptUpdateForm(DeptInfoForm _frm2)
        {
            InitializeComponent();
            _frm1 = _frm2;
        }
        ...
        {
            int id = int.Parse(input_dept_id.Text);
            ...
            string sql = "update sys_dept_info set dept_name=\'"+dept_name+"\', remark_dc = \'"+remark_dc+"\' where id="+id;
        ...
        private void dept_update_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                // 엔터키
